...
class AppTest {
    ...
    // BEGIN
    @Test
    void testCharSequence1() {
        CharSequence text = new ReversedSequence("mother");
        String actual = text.toString();
        String expected = "rehtom";
        assertThat(actual).isEqualTo(expected);
    }

    @Test
    void testCharSequence2() {
    ...
    @Test
    void testCharSequence3() {
        CharSequence text = new ReversedSequence("mother");
        String string = "rehtom";
        char expected = string.charAt(0);

        assertThat(text.charAt(0)).isEqualTo(expected);
    }

    @Test
    void testCharSequense4() {
        CharSequence text = new ReversedSequence("mother");

        String actual = text.subSequence(0, 2).toString();
        String expected = "re";
        assertThat(actual).isEqualTo(expected);
    }
    // END
